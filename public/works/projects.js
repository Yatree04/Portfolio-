 ...
 * ---------------------------------------------------------------------------
 * One entry per tile, in the order they appear. Each is a Behance embed and
 * nothing else — the tile renders the embed on its own, with no text under it.
 *
 *   embed   A Behance project: paste either the URL or the whole <iframe ...>
 *           from the project's Share -> Embed dialog.
 *
 * The renderer also understands `image`, `eyebrow`, `title`, `url` and
 * `description` for a tile built around cover art (Figma node 89:6276). None
